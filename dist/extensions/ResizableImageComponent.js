...
function ResizableImageComponent({ node, selected, updateAttributes }) {
    ...
    return ((0, jsx_runtime_1.jsx)(react_1.NodeViewWrapper, { style: {
            ...
            width: "100%",
        }, children: (0, jsx_runtime_1.jsxs)("div", { className: classes.imageContainer, children: [(0, jsx_runtime_1.jsx)("img", { ref: imageRef, src: attrs.src, height: "auto", width: attrs.width ? attrs.width : undefined, 
                    ...
                    } }), selected && ((0, jsx_runtime_1.jsx)(ResizableImageResizer_1.ResizableImageResizer, { onResize: handleResize, className: classes.resizer }))] }) }));
}
