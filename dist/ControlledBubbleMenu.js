...
const controlledBubbleMenuClasses = (0, styles_1.getUtilityClasses)(ControlledBubbleMenu.name, ["root", "paper"]);
...
function ControlledBubbleMenu({ editor, open, className, classes: overrideClasses = {}, children, anchorEl, container, disablePortal, placement = "top", fallbackPlacements = [
    "top",
    "bottom",
    "top-start",
    "bottom-start",
    ...
    return ((0, jsx_runtime_1.jsx)(material_1.Popper, { open: open, placement: placement, modifiers: [
            {
                name: "offset",
                options: {
        ...
        ], anchorEl: anchorEl !== null && anchorEl !== void 0 ? anchorEl : defaultAnchorEl, className: cx(controlledBubbleMenuClasses.root, classes.root, className), container: container, disablePortal: disablePortal, transition: true, children: ({ TransitionProps }) => ((0, jsx_runtime_1.jsx)(material_1.Fade, Object.assign({}, TransitionProps, { timeout: {
